...
{
	std::string path = "https://screenscraper.gamestation.com/api/thegamedb/GetGame.php?";
	std::string languageSystem = GamestationConf::getInstance()->get("system.language");
