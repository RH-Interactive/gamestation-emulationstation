...
bool ViewController::input(InputConfig* config, Input input)
{
	...
	// open menu
	if(config->isMappedTo("start", input) && input.value != 0 && GamestationConf::getInstance()->get("system.es.menu") != "none" )
	{
		// open menu
...
std::vector<HelpPrompt> ViewController::getHelpPrompts()
{
	...
	if(GamestationConf::getInstance()->get("system.es.menu") != "none"){
